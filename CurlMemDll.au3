...
#include-once
#include "Subrogation_min.au3"
#include "base64.au3"
#include "libcurl.dll.au3"
#include "array.au3"
...
Func __Curl_DllOpen()
    If Not @AutoItX64 Then Return SetError(1,0,0); We only work /w x64
	;$g_hlibcurl = DllOpen(@AutoItX64 ? 'libcurl-x64.dll' : 'libcurl.dll')
    $g_hlibcurl = _DllFromMemory(_Base64Decode($g_vMemDll_libcurl))
	If @error Or $g_hlibcurl = -1 Then MsgBox(16, 'ERROR', 'Error opening ' & (@AutoItX64 ? 'libcurl-x64.dll' : 'libcurl.dll'))
